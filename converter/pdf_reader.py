...
.. deprecated::
    This module is a backward-compatibility facade. New code should import
    directly from :mod:`converter.extract`, :mod:`converter.models`, etc.
    The re-exports here exist so that existing ``from converter.pdf_reader import ...``
    call sites (primarily tests) keep working during the migration.
